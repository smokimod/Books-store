...
export const Terms = ({ contentView }) => (
    <div className='terms-section'>
        <h3 className='rules-logo'>{contentView}</h3>
        <div className='rules-wraper'>
            <ul className='rule-section-gap'>
                <li className='term-bold'>
                    ...
                    <ul className='rule-gap'>
                        <li className='termOne item'>
